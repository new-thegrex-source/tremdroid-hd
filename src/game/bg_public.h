...
#define SS_POISONCLOUDED        0x00000100
#define SS_ICEWAVED		0x00000200
...
typedef enum
{
  ...
  WP_ALEVEL1,
  WP_ALEVEL1_UPG,
//  WP_ALEVEL6, wraith, to be better times...
  WP_ALEVEL2,
  WP_ALEVEL2_UPG,
  WP_ALEVEL5,
  WP_ALEVEL3,
...
typedef enum
{
  ...
  PCL_ALIEN_BUILDER0_CRZ,
  //offensive classes
  PCL_ALIEN_LEVEL0,
  PCL_ALIEN_LEVEL0_UPG,
  PCL_ALIEN_LEVEL0_NUC,
  PCL_ALIEN_LEVEL1,
