...
#define DEFAULT_ALIEN_BUILDPOINTS   "999"
#define DEFAULT_ALIEN_QUEUE_TIME    "12000"
#define DEFAULT_ALIEN_STAGE2_THRESH "15000"
#define DEFAULT_ALIEN_STAGE3_THRESH "19000"
#define DEFAULT_ALIEN_STAGE4_THRESH "25000"
#define DEFAULT_ALIEN_STAGE5_THRESH "44000"
#define DEFAULT_ALIEN_MAX_STAGE     "4"
#define DEFAULT_HUMAN_BUILDPOINTS   "999"
#define DEFAULT_HUMAN_QUEUE_TIME    "8000"
#define DEFAULT_HUMAN_STAGE2_THRESH "8000"
#define DEFAULT_HUMAN_STAGE3_THRESH "16000"
#define DEFAULT_HUMAN_STAGE4_THRESH "24000"
#define DEFAULT_HUMAN_STAGE5_THRESH "32000"
...
#define ABUILDER_HEALTH             AHM(70)
#define ABUILDER_REGEN              (0.08f * ABUILDER_HEALTH)
...
#define ABUILDER_CRZ_SPEED          2.2f
#define ABUILDER_CRZ_VALUE          AVM(400)
#define ABUILDER_CRZ_HEALTH         AHM(20)
#define ABUILDER_CRZ_REGEN          (0.1f * ABUILDER_UPG_HEALTH)
#define ABUILDER_CRZ_COST           0
...
#define ABUILDER_BLOB_DMG_UPG       ADM(400)
#define ABUILDER_BLOB_REPEAT_UPG    1500
#define ABUILDER_BLOB_SPEED_UPG     200.0f
#define ABUILDER_BLOB_SPEED_MOD_UPG 0.5f
#define ABUILDER_BLOB_TIME_UPG      2000
#define ABUILDER_BLOB_RADIUS_UPG    150.0f
...
//nuclear
#define LEVEL0_NUC_SPEED            1.6f
#define LEVEL0_NUC_VALUE            AVM(220)
#define LEVEL0_NUC_HEALTH           AHM(16)
#define LEVEL0_NUC_REGEN            (0.05f * LEVEL0_NUC_HEALTH)
#define LEVEL0_NUC_COST             2
#define LEVEL0_NUC_BITE_RANGE       250.0f
#define LEVEL0_NUC_BITE_WIDTH       150.0f

#define LEVEL0_BITE_DMG             ADM(40)
#define LEVEL0_BITE_DMG_UPG         ADM(50) 
#define LEVEL0_BITE_DMG_NUC         ADM(8) 
#define LEVEL0_BITE_RANGE           64.0f
#define LEVEL0_BITE_WIDTH           6.0f
#define LEVEL0_BITE_REPEAT          500
#define LEVEL0_BITE_REPEAT_NUC      386
#define LEVEL0_BITE_K_SCALE         1.0f
#define LEVEL0_BITE_K_SCALE_NUC         1.0f
...
#define LEVEL2_BOUNCEBALL_REPEAT    400
...
#define LEVEL4_FIREBREATHREPEAT     2000
#define LEVEL4_FIREBREATHRELOADTIME 15000
#define LEVEL4_FIREBREATHSPEED 		900
#define LEVEL4_FIREBREATHDMG 		35

//Hummel
#define LEVEL5_SPEED            0.81f
#define LEVEL5_VALUE            AVM(400)
#define LEVEL5_HEALTH           AHM(140)
#define LEVEL5_REGEN            (0.04f * LEVEL5_UPG_HEALTH)
#define LEVEL5_COST             1
#define LEVEL5_UPG_SPEED            0.71f
#define LEVEL5_UPG_VALUE            AVM(400)
#define LEVEL5_UPG_HEALTH           AHM(160)
#define LEVEL5_UPG_REGEN            (0.02f * LEVEL5_UPG_HEALTH)
#define LEVEL5_UPG_COST             1
...
/*
//hujeta
#define LEVEL6_SPEED                1.25f
#define LEVEL6_VALUE                AVM(270)
#define LEVEL6_HEALTH               AHM(60)
#define LEVEL6_REGEN                (0.03f * LEVEL1_HEALTH)
#define LEVEL6_COST                 1

#define LEVEL6_CLAW_DMG             ADM(32)
#define LEVEL6_CLAW_RANGE           64.0f
#define LEVEL6_CLAW_U_RANGE         LEVEL1_CLAW_RANGE + 3.0f
#define LEVEL6_CLAW_WIDTH           10.0f
#define LEVEL6_CLAW_REPEAT          600
#define LEVEL6_CLAW_K_SCALE         1.0f

#define LEVEL6_WARP_TIME            5000
#define LEVEL6_WARP_REGEN_DELAY     2000
#define LEVEL6_WARP_REGEN_RATE      1
f/
...
#define BLASTER_DMG                 HDM(5) // DPS: 7.14
...
#define PAINSAW_REPEAT2             2500
#define PAINSAW_DAMAGE2             HDM(90) // DPS: 20
#define PAINSAW_DAMAGESPLASH2       5
#define PAINSAW_BLADELIFETIME       3500
#define PAINSAW_BLADESPEED          500.0f
#define PAINSAW_BLADERANGE          90.0f

#define GRENADE_PRICE               300
#define GRENADE_REPEAT              0
#define GRENADE_K_SCALE             1.0f
#define GRENADE_DAMAGE              HDM(440)
#define GRENADE_RANGE               152.0f
...
#define ROCKETL_PRICE               1000
#define ROCKETL_AMMO                10
#define ROCKETL_CLIPS               1
#define ROCKETL_RELOAD              0
#define ROCKETL_REPEAT              2200
#define ROCKETL_K_SCALE             1.0f
#define ROCKETL_DAMAGE              HDM(100) // DPS: 66.67
...
#define BATTPACK_PRICE              250
#define BATTPACK_MODIFIER           2.0f 		//modifier for extra energy storage available

#define AMMOPACK_PRICE              100
#define AMMOPACK_MODIFIER           1.0f //modifier for extra ammo storage available

#define CLOAK_PRICE                 400
#define CLOAK_TIME                  90000

#define JETPACK_PRICE               120
#define JETPACK_FLOAT_SPEED         600.0f 		//up movement speed
#define JETPACK_SINK_SPEED          500.0f 		//down movement speed
...
#define INFESTATION_SLIME_BT                    10000
...
#define MGTURRET2_DMG                HDM(8)
#define MGTURRET2_SPINUP_TIME        550 		// time between target sighted and fire
#define MGTURRET2_VALUE              HBVM(MGTURRET2_BP)

#define MGTURRET3_BP                 90
#define MGTURRET3_BT                 30000
#define MGTURRET3_HEALTH             HBHM(460)
#define MGTURRET3_SPLASHDAMAGE       100
#define MGTURRET3_SPLASHRADIUS       100
#define MGTURRET3_ANGULARSPEED       12
#define MGTURRET3_ACCURACY_TO_FIRE   0
#define MGTURRET3_VERTICALCAP        30  		// +/- maximum pitch
#define MGTURRET3_REPEAT             1150
#define MGTURRET3_K_SCALE            1.0f
#define MGTURRET3_RANGE              380.0f
#define MGTURRET3_SPREAD             200
#define MGTURRET3_DMG                HDM(55)
#define MGTURRET3_SPINUP_TIME        1750 		// time between target sighted and fire
#define MGTURRET3_VALUE              HBVM(MGTURRET3_BP)
...
#define DC_ATTACK_PERIOD            25000 		// how often to spam "under attack"
