...
#define G_MOD_VERSION "^2TDHD v1.3" SVN_VERSION
...
vmCvar_t  g_minTeamSizePerBuilderA;
vmCvar_t  g_minTeamSizePerBuilderH;
vmCvar_t  g_buildableSvfBroadcast;
vmCvar_t  g_tag;
vmCvar_t  g_slapKnockback;
vmCvar_t  g_JumppadPower;
vmCvar_t  g_InstantRewardMultiplierA;
...
static cvarTable_t   gameCvarTable[ ] =
{
  ...
  { NULL, "tremdroid_version", NEWEDGE_MOD_VERSION , CVAR_SERVERINFO | CVAR_ROM, 0, qfalse  },
  ...
  // latched vars
  { &g_maxclients, "sv_maxclients", "41", CVAR_SERVERINFO | CVAR_LATCH | CVAR_ARCHIVE, 0, qfalse  },
  { &g_maxGameClients, "g_maxGameClients", "0", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qfalse  },
  { &g_timelimit, "timelimit", "60", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
  ...
  { &g_weakSuddenDeathTime, "g_weakSuddenDeathTime", "35", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
  ...
  { &g_friendlyFreeze, "g_friendlyFreeze", "1", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qfalse  },
  { &g_friendlyFire, "g_friendlyFire", "1", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qtrue  },
  { &g_friendlyBuildableFire, "g_friendlyBuildableFire", "1", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qtrue  },
  { &g_dretchPunt, "g_dretchPunt", "1", CVAR_ARCHIVE, 0, qtrue  },
  { &g_teamForceBalance, "g_teamForceBalance", "1", CVAR_ARCHIVE, 0, qtrue },
  { &g_warmup, "g_warmup", "20", CVAR_ARCHIVE, 0, qtrue  },
  { &g_doWarmup, "g_doWarmup", "1", CVAR_ARCHIVE, 0, qtrue  },
  { &g_logFile, "g_logFile", "tdhd.log", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_voteLimit, "g_voteLimit", "4", CVAR_ARCHIVE, 0, qfalse },
  { &g_suddenDeathVotePercent, "g_suddenDeathVotePercent", "70", CVAR_ARCHIVE, 0, qfalse },
  { &g_suddenDeathVoteDelay, "g_suddenDeathVoteDelay", "180", CVAR_ARCHIVE, 0, qfalse },
  { &g_armageddonVotePercent, "g_armageddonVotePercent", "70", CVAR_ARCHIVE, 0, qfalse },
  { &g_armageddonPercent, "g_armageddonPercent", "30", CVAR_ARCHIVE, 0, qfalse }, 
  { &g_readyPercent, "g_readyPercent", "100", CVAR_ARCHIVE, 0, qfalse },
  { &g_minNameChangePeriod, "g_minNameChangePeriod", "5", 0, 0, qfalse},
  { &g_maxNameChanges, "g_maxNameChanges", "10", 0, 0, qfalse},
  ...
  { &g_teamImbalanceWarnings, "g_teamImbalanceWarnings", "80", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_shove, "g_shove", "8", CVAR_ARCHIVE, 0, qfalse  },
  { &g_antiSpawnBlock, "g_antiSpawnBlock", "1", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_newbieNamePrefix, "g_newbieNamePrefix", "^1N^2e^7w^3b^8i^5e#", CVAR_ARCHIVE, 0, qfalse  },
  { &g_admin, "g_admin", "admin.dat", CVAR_ARCHIVE, 0, qfalse  },
  { &g_adminTempBan, "g_adminTempBan", "40m", CVAR_ARCHIVE, 0, qfalse  },
  { &g_adminMaxBan, "g_adminMaxBan", "999w", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_devmapKillerHP, "g_devmapKillerHP", "1", CVAR_ARCHIVE, 0, qtrue  },
  ...
  { &g_BuildingCreditsFactor, "g_BuildingCreditsFactor", "0.1", CVAR_ARCHIVE, 0, qfalse }
};
...
void G_InitGame( int levelTime, int randomSeed, int restart )
{
  ...
  srand( randomSeed );
  G_RegisterCvars( );
  G_Printf( "^5------- Game Initialization -------\n" );
  G_Printf( "^5gamename: %s\n", GAME_VERSION );
  G_Printf( "^5gamedate: %s\n", __DATE__ );
  G_Printf( "^2T^7rem^2D^7roid ^2H^7D version: %s\n", NEWEDGE_MOD_VERSION );
  G_Printf( "^5Game SUCCESSFULLY Loaded!\n" );
  BG_InitMemory( );
  ...
  trap_Cvar_Set( "tremdroid_version", NEWEDGE_MOD_VERSION );
  ...
  G_LogCombatSettings( );
  G_Printf( "^5-----------------------------------\n" );
  G_Printf( "^5TDHD LOADED SUCCESSFULLY\n" );
  ...
  G_SoundIndex( "sound/buildables/human/spawn1.wav" );//
  G_SoundIndex( "sound/buildables/alien/spawn1.wav" );//
}
...
void G_ShutdownGame( int restart )
{
  ...
  G_ClearVotes( );
  G_RestoreCvars( );
  G_Printf( "^5==== ShutdownGame ====\n" );
  if( level.logFile )
  {
    G_LogPrintf( "^5ShutdownGame:\n" );
    G_LogPrintf( "^5------------------------------------------------------------\n" );
...
void G_SpawnClients( team_t team )
{
  ...
  if( numSpawns == -1 )
  {
	...
	{
	  trap_SendServerCommand( ent->client - level.clients, "print \"^5Your team has more players. Either switch to the other team or wait for someone in your team to die....\n\"");
...
void CalculateRanks( void )
{
  ...
  level.numAlienBuilders = 0;
  level.numHumanBuilders = 0;
        ...
        //  if( level.clients[ i ].sess.spectatorState == SPECTATOR_NOT )
		  if( level.clients[ i ].sess.spectatorState == SPECTATOR_NOT ) {
            level.numLiveAlienClients++;
			           if (level.clients[ i ].pers.classSelection == PCL_ALIEN_BUILDER0 ||
               level.clients[ i ].pers.classSelection == PCL_ALIEN_BUILDER0_UPG ||
               level.clients[ i ].pers.classSelection == PCL_ALIEN_BUILDER0_CRZ)
             level.numAlienBuilders++;
         }
        }
     ...
     //     if( level.clients[ i ].sess.spectatorState == SPECTATOR_NOT )
		 if( level.clients[ i ].sess.spectatorState == SPECTATOR_NOT ) {
            level.numLiveHumanClients++;
		          if (level.clients[ i ].ps.weapon == WP_HBUILD)
            level.numHumanBuilders++;
        }
        }
      }
    }
...
void CheckIntermissionExit( void )
{
  ...
  if( level.time > level.intermissiontime + 40000 )
  {
    ExitLevel( );
    return;
  }
...
void CheckExitRules( void )
{
  ...
  if( g_timelimit.integer )
  {
    if( level.time - level.startTime >= g_timelimit.integer * 60000 )
    {
      ...
      trap_SendServerCommand( -1, "print \"^5Timelimit hit\n\"" );
    ...
    {
      trap_SendServerCommand( -1, "cp \"^11 minute remaining!\"" );
      level.timelimitWarning = TW_PASSED;
    }
  }
        ...
        ( level.numLiveAlienClients == 0 ) ) )
  {
    ...
    trap_SendServerCommand( -1, "cp \"^4Humans Win\"");
    trap_SendServerCommand( -1, "print \"^4==-->>>Humans win<<<--==\n\"");
    trap_SetConfigstring( CS_WINNER, "[yehwin]" );
	G_SoundIndex( "sound/feedback/humanswin.wav" );
    LogExit( "Humans win." );
    G_MapLog_Result( 'h' );
  }
             ...
             ( level.numLiveHumanClients == 0 ) ) )
  {
    ...
    trap_SendServerCommand( -1, "cp \"^1Aliens Win\"");
    trap_SendServerCommand( -1, "print \"^1==-->>>Aliens win<<<--==\n\"");
    trap_SetConfigstring( CS_WINNER, "[yeawin]" );
	G_SoundIndex( "sound/feedback/alienswin.wav" );
    LogExit( "Aliens win." );
    G_MapLog_Result( 'a' );
  }
...
void G_ArmageddonStep( void )
{
  ...
  gentity_t *ent;
  char argv[ 5 ];
  float thresholdDefensive,thresholdOther;
 
  thresholdDefensive = g_armageddonDefensiveKillPercent.integer / 100.0f;
  thresholdOther = g_armageddonOtherKillPercent.integer / 100.0f;
  ...
  for(e=0,ent=g_entities;e<level.num_entities;++e,++ent) {
    ...
    case BA_A_HIVE:
    case BA_H_SHIELD:
      if (thresholdDefensive > 0.0f) if (random() < thresholdDefensive) {
         ent->health = -999;
...
void G_RunFrame( int levelTime )
{
  ...
  if( level.pausedTime )
  {
    ...
    while( ptime3000 > 3000 )
    {
      ...
      if( level.pausedTime >= 110000  && level.pausedTime <= 119000 )
        trap_SendServerCommand( -1, va( "print \"^5Server: Game will auto-unpause in %d seconds\n\"", 
    ...
    {
      trap_SendServerCommand( -1, "print \"^5Server: The game has been unpaused automatically (2 minute max)\n\"" );
  ...
  if (level.time - level.startTime > level.nextArmageddonKillTime) 
  {
    G_ArmageddonStep();
    level.nextArmageddonKillTime = level.time - level.startTime + g_armageddonTimeStep.integer * 60000;
  }
  //
