...
//ALIEN BUILDINGS
  ...
  },
  {
    ...
    "[xy2]Panzer Small",       //char      *humanName;
  ...
  },
  {
    ...
    "[xy2]Panzer Medium",      //char      *humanName;
  ...
  },
  {
    ...
    "[xy2]Panzer Large",       //char      *humanName;
  ...
  },
  {
    ...
    "[xy2]Tendon Small",       //char      *humanName;
	"LIGHT ORGANIC STRUCTURE\n"
  ...
  },
  {
    ...
    "[xy2]Tendon Medium",           //char      *humanName;
	"AVERAGE ORGANIC STRUCTURE\n"
    "[yei]Used for passive base defense or bridges.\n"
	"50HP",
  ...
  },
  {
    ...
    "[xy2]Tendon Large",           //char      *humanName;
	"HEAVY ORGANIC STRUCTURE\n"
  ...
  },
  {
    ...
    "net",           //char      *buildName;
    "[rcz]Grass",           //char      *humanName;
	"LEGENDARY BUILDABLE FROM ^3RfCZ\n"
    "[yei]Used for passive base defense.\n"
  ...
  },
  {
    ...
    "[xy2]Infestation Slime",           //char      *humanName;
  ...
  },
  {
    ...
    "[xy2]Infestation Thicket",           //char      *humanName;
   ...
   },
   {
    ...
    "[xy2]Infestation Blister",         //char      *humanName;
  ...
  },
  {
    ...
    "[xy2]Spiteful Abcess",           //char      *humanName;
	"INTELLIGENT ORGANIC STRUCTURE\n"
  ...
  },
  {
    ...
    "[xytd]Magic Rock",           		 //char      *humanName;
	"INTELLIGENT ORGANIC STRUCTURE\n"
    "[yei]This heals your team faster\n"
    "+faster adv.goon barb regen.\n"
	"Can only be built once (Model from ^3RCZ)\n",
  ...
  },
  {
    ...
    "[xy2]Organic Bulb",           //char      *humanName;
	"INTELLIGENT ORGANIC STRUCTURE\n"
  ...
  },
  {
    ...
    "pod",           				//char      *buildName;
    "[xy2]Pod",           			//char      *humanName;
	"HEAVY ORGANIC STRUCTURE\n"
    "[yei]This contains on top of the Pod Stump (tree).\n"
  ...
  },
  {
    ...
    "[rcz]Tree",           	//char      *humanName;
	"LEGENDARY RCZ BUILDABLE\n"
    "[yei]This is the tree.\n",
  ...
  },
  {
    ...
    "[xy2]Creep colony",        	//char      *humanName;
...
//HUMAN BUILDINGS
  ...
  },
  {
    ...
    "[xy]Flame Turret",   		//char      *humanName;
    "Automated base defense that is effective against large targets "
      "but slow to begin firing. Should always be "
      "backed up by physical support.",
  ...
  {
    BA_H_MGTURRET3,         		//int       buildNum;
    "mgturret3",            		//char      *buildName;
    "[xytd]Rocket Turret",   		//char      *humanName;
    "Automated base defense that is effective against large targets "
      "has big dmg, but low reload "
      "speed and shoot...",
    "team_human_mgturret2", 		//char      *entityName;
    TR_GRAVITY,            			//trType_t  traj;
    0.0,                   			//float     bounce;
    MGTURRET3_BP,           		//int       buildPoints;
    STAGE_GE_4,                		//int  stages
    MGTURRET2_HEALTH,       		//int       health;
    0,                     			//int       regenRate;
    MGTURRET3_SPLASHDAMAGE, 		//int       splashDamage;
    MGTURRET3_SPLASHRADIUS, 		//int       splashRadius;
    MOD_HSPAWN,            			//int       meansOfDeath;
    TEAM_HUMANS,            		//int       team;
    ( 1 << WP_HBUILD ),   			//weapon_t  buildWeapon;
    BANIM_IDLE1,           			//int       idleAnim;
    50,                    			//int       nextthink;
    MGTURRET3_BT,           		//int       buildTime;
    qfalse,                			//qboolean  usable;
    MGTURRET3_RANGE,        		//int       turretRange;
    MGTURRET3_REPEAT,       		//int       turretFireSpeed;
    WP_MGTURRET3,           		//weapon_t  turretProjType;
    0.0f,                 			//float     minNormal; 
    qtrue,                			//qboolean  invertNormal; 
    qfalse,                			//qboolean  creepTest;
    0,                     			//int       creepSize;
  ...
  },
  {
    ...
    "[xy]Container Small",   		//char      *humanName;
	"SOLID STRUCTURE\n"
    "[yei]Used for passive base defense.\n"
  ...
  }, 
  {
    ...
    "[xy]Container Medium",   	//char      *humanName;
	"SOLID STRUCTURE\n"
    "[yei]Used for passive base defense.\n"
    "This building doesn't need a powered area!\n",
  ...
  }, 
  {
    ...
    "[xy]Container Large",   		//char      *humanName;
	"SOLID STRUCTURE\n"
    "[yei]Used for passive base defense.\n"
    "This building doesn't need a powered area!\n",
  ...
  }, 
  {
    ...
    "[xy]Barrier Line",   		//char      *humanName;
	"SOLID STRUCTURE\n"
    "[yei]Used for passive base defense.\n"
    "This building doesn't need a powered area!\n",
  ...
  }, 
  {
    ...
    "[xy]Barrier Corner",   		//char      *humanName;
	"SOLID STRUCTURE\n"
    "[yei]Used for passive base defense.\n"
    "This building doesn't need a powered area!\n",
  ...
  }, 
  {
    ...
    "[xy]Barrier Point",   		//char      *humanName;
	"SOLID STRUCTURE\n"
    "[yei]Used for passive base defense.\n"
    "This building doesn't need a powered area!\n",
...
static const classAttributes_t bg_classList[ ] =
{
  ...
  },
  {
    ...
    270.0f,                                         //float   jumpMagnitude;
    1.0f,                                           //float   knockbackScale;
    { PCL_ALIEN_BUILDER0_CRZ, PCL_ALIEN_LEVEL0, PCL_NONE },       //int     children[ 3 ];
    ABUILDER_UPG_COST,                              //int     cost;
    ABUILDER_UPG_VALUE,                             //int     value;
  },
    {
    PCL_ALIEN_BUILDER0_CRZ,                         //int     classnum;
    "buildercrz",                                   //char    *classname;
    "Similar to the base Granger, except that in addition "
      "has a faster speed, superjump, but a lower hp.  " 
      "This alien class is a very effective solution" 
	  "for killing Rocket Turrets.", 
    STAGE_GE_3,                                     //int  stages
    ABUILDER_CRZ_HEALTH,                            //int     health;
    0.0f,                                           //float   fallDamage;
    ABUILDER_CRZ_REGEN,                             //float   regenRate;
    SCA_FOVWARPS|SCA_WALLCLIMBER|SCA_ALIENSENSE,    //int     abilities;
    WP_ABUILD,                                      //weapon_t  startWeapon
    105.0f,                                         //float   buildDist;
    120,                                            //int     fov;
    ...
    2.0f,                                           //float   bobCycle;
    100,                                            //int     steptime;
    ABUILDER_CRZ_SPEED,                         //float   speed;
    10.0f,                                          //float   acceleration;
    1.5f,                                           //float   airAcceleration;
    12.0f,                                          //float   friction;
    100.0f,                                         //float   stopSpeed;
    550.0f,                                         //float   jumpMagnitude;
    1.0f,                                           //float   knockbackScale;
    { PCL_ALIEN_LEVEL0, PCL_NONE, PCL_NONE },       //int     children[ 3 ];
    ABUILDER_CRZ_COST,                              //int     cost;
    ABUILDER_CRZ_VALUE,                              //int     value;
  },
  {
    ...
    { PCL_ALIEN_LEVEL0_UPG, PCL_ALIEN_LEVEL1, PCL_NONE },       //int     children[ 3 ];
  ...
  },
  {
    ...
    250.0f,                                         //float   jumpMagnitude;
    2.0f,                                           //float   knockbackScale;
    { PCL_ALIEN_LEVEL0_NUC, PCL_ALIEN_LEVEL1, PCL_NONE },       //int     children[ 3 ];
    LEVEL0_UPG_COST,                                //int     cost;
    LEVEL0_UPG_VALUE                                //int     value;
  },
  {
    PCL_ALIEN_LEVEL0_NUC,                           //int     classnum;
    "level0nuc",                                    //char    *classname;
    "In addition to the basic and Advanced Dretch abilities, the Nuclear "
      "Dretch has the ability to infect radiation and spread infections. ",
    STAGE_GE_3,                                     //int  stages
    LEVEL0_NUC_HEALTH,                              //int     health;
    0.0f,                                           //float   fallDamage;
    LEVEL0_NUC_REGEN,                               //float   regenRate;
    SCA_WALLCLIMBER|SCA_FOVWARPS|SCA_ALIENSENSE,    //int     abilities;
    WP_ALEVEL0_NUC,                                 //weapon_t  startWeapon
    0.0f,                                           //float   buildDist;
    180,                                            //int     fov;
    0.0f,                                           //float   bob;
    2.5f,                                           //float   bobCycle;
    25,                                             //int     steptime;
    LEVEL0_NUC_SPEED,                               //float   speed;
    10.0f,                                          //float   acceleration;
    1.0f,                                           //float   airAcceleration;
    6.0f,                                           //float   friction;
    400.0f,                                         //float   stopSpeed;
    280.0f,                                         //float   jumpMagnitude;
    2.0f,                                           //float   knockbackScale;
    { PCL_ALIEN_LEVEL1, PCL_NONE, PCL_NONE },       //int     children[ 3 ];
    LEVEL0_NUC_COST,                                //int     cost;
    LEVEL0_NUC_VALUE                                //int     value;
  },
  {
  ...
  },
  {
    ...
    { PCL_ALIEN_LEVEL2, PCL_ALIEN_LEVEL2_UPG, PCL_NONE },       //int     children[ 3 ];
  ...
  {
    PCL_ALIEN_LEVEL6,                               //int     classnum;
    "level6",                                       //char    *classname;
    "A support class able to crawl on walls and ceilings. Its melee "
      "attack is most effective when combined with the ability to grab "
      "and hold its victims in place. Provides a weak healing aura "
      "that accelerates the healing rate of nearby aliens. It also has "
      ...
      "The basilisk is also resistant to flamer.",
    STAGE_GE_4,                                     //int     stages
    LEVEL6_HEALTH,                                  //int     health;
    0.0f,                                           //float   fallDamage;
    LEVEL6_REGEN,                                   //float   regenRate;
    SCA_WALLJUMPER|SCA_FOVWARPS|SCA_WALLCLIMBER|SCA_ALIENSENSE,    //int     abilities;
    WP_ALEVEL6,                                     //weapon_t  startWeapon
    0.0f,                                           //float   buildDist;
    120,                                            //int     fov;
    0.001f,                                         //float   bob;
    1.8f,                                           //float   bobCycle;
    60,                                             //int     steptime;
    LEVEL6_SPEED,                                   //float   speed;
    10.0f,                                          //float   acceleration;
    1.0f,                                           //float   airAcceleration;
    6.0f,                                           //float   friction;
    300.0f,                                         //float   stopSpeed;
    ...
    LEVEL6_COST,                                    //int     cost;
    LEVEL6_VALUE,                                   //int     value;
	  },
	*/
  {
  ...
  },
  {
    ...
    STAGE_GE_3,                                     //int  stages
    LEVEL5_HEALTH,                              //int     health;
    0.0f,                                           //float   fallDamage;
    LEVEL5_REGEN,                               //float   regenRate;
    SCA_FOVWARPS|SCA_ALIENSENSE|SCA_WALLJUMPER,         //int     abilities;
    ...
    250.0f,                                         //float   jumpMagnitude;
    0.7f,                                           //float   knockbackScale;
    { PCL_ALIEN_LEVEL5_UPG, PCL_ALIEN_LEVEL3, PCL_NONE },       //int     children[ 3 ];
    LEVEL5_COST,                                //int     cost;
    LEVEL5_VALUE,                                //int     value;
  },
  {
    PCL_ALIEN_LEVEL5_UPG,                               //int     classnum;
    "level5upg",                                       //char    *classname;
    "The Hummel is a flying alien with air pounce ability, "
      "fast melee attacks and unlimited low damage shooting attack "
      "that does not spread poison.",
    STAGE_GE_4,                                     //int  stages
...
static const weaponAttributes_t bg_weapons[ ] =
{
  ...
  {
    WP_ALEVEL0_NUC,       //int       weaponNum;
    0,                    //int       price;
    STAGE_GE_3,           //int  stages
    SLOT_WEAPON,          //int       slots;
    "level0nuc",          //char      *weaponName;
    "Bite Nuclear",       //char      *humanName;
    "",
    0,                    //int       maxAmmo;
    0,                    //int       maxClips;
    qtrue,                //int       infiniteAmmo;
    qfalse,               //int       usesEnergy;
    LEVEL0_BITE_REPEAT_NUC,   //int       repeatRate1;
    0,                    //int       repeatRate2;
    0,                    //int       repeatRate3;
    0,                    //int       reloadTime;
    LEVEL0_BITE_K_SCALE_NUC,  //float     knockbackScale;
    qfalse,               //qboolean  hasAltMode;
    qfalse,               //qboolean  hasThirdMode;
    qfalse,               //qboolean  canZoom;
    90.0f,                //float     zoomFov;
  ...
  /*
  {
    WP_ALEVEL6,           //int       weaponNum;
    0,                    //int       price;
    STAGE_GE_1,           //int  stages
    SLOT_WEAPON,          //int       slots;
    "level6",             //char      *weaponName;
    "Claws",              //char      *humanName;
    "",
    1,                    //int       maxAmmo;
    0,                    //int       maxClips;
    qtrue,                //int       infiniteAmmo;
    qfalse,               //int       usesEnergy;
    LEVEL6_CLAW_REPEAT,   //int       repeatRate1;
    0,                    //int       repeatRate2;
    0,                    //int       repeatRate3;
    0,                    //int       reloadTime;
    LEVEL6_CLAW_K_SCALE,  //float     knockbackScale;
    qfalse,               //qboolean  hasAltMode;
    qfalse,               //qboolean  hasThirdMode;
    qfalse,               //qboolean  canZoom;
    90.0f,                //float     zoomFov;
  ...
  {
    WP_MGTURRET3,         //int       weaponNum;
    0,                    //int       price;
    STAGE_GE_1,           //int  stages
    SLOT_WEAPON,          //int       slots;
    "mgturret3",          //char      *weaponName;
    "Machinegun Turret3", //char      *humanName;
    "",
    0,                    //int       maxAmmo;
    0,                    //int       maxClips;
    qtrue,                //int       infiniteAmmo;
    ...
    0,                    //int       repeatRate3;
    0,                    //int       reloadTime;
    MGTURRET3_K_SCALE,    //float     knockbackScale;
    qfalse,               //qboolean  hasAltMode;
    qfalse,               //qboolean  hasThirdMode;
    qfalse,               //qboolean  canZoom;
    90.0f,                //float     zoomFov;
...
static const upgradeAttributes_t bg_upgrades[ ] =
{
  ...
  },
  {
    ...
    "Back-mounted battery pack that permits storage of one and a half "
      ...
      "Have specific feature: after die battery was damaging."
      "Any aliens in Radius "
      "(Also Killing any aliens if he have less that 74hp).",
  ...
  },
  {
    ...
    "[yeampk]Ammo Pack",            //char  *upgradeHumanName;
