...
static void UI_LoadAlienClasses( void )
{
  ...
  if( BG_ClassIsAllowed( PCL_ALIEN_BUILDER0_CRZ ) &&
      BG_ClassAllowedInStage( PCL_ALIEN_BUILDER0_CRZ, UI_GetCurrentAlienStage( ) ) )
    UI_AddClass( PCL_ALIEN_BUILDER0_CRZ );
...
{
  static char dlText[]  = "^5Downloading:";
  static char etaText[] = "^5Estimated time left:";
  static char xferText[]  = "^5Transfer rate:";
...
void UI_DrawConnectScreen( qboolean overlay )
{
  ...
  {
    case CA_CONNECTING:
      s = va( "^5Awaiting connection...%i", cstate.connectPacketCount );
      break;

    case CA_CHALLENGING:
      s = va( "^5Awaiting challenge...%i", cstate.connectPacketCount );
      break;
    ...
    case CA_CONNECTED:
      {
        ...
        if( prompt & DLP_SHOW ) {
          Com_Printf("^1Opening download prompt...\n");
          trap_Key_SetCatcher( KEYCATCH_UI );
