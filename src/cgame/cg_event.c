...
static void CG_Obituary( entityState_t *ent )
{
  ...
  {
    case MOD_FALLING:
      message = "^1fell fowl to gravity";
      break;
    case MOD_CRUSH:
      message = "^1was squished";
      break;
    case MOD_WATER:
      message = "^1forgot to pack a snorkel";
      break;
    case MOD_SLIME:
      message = "^1was sucked by an infestation slime";
      break;
    case MOD_LAVA:
      message = "^1did a back flip into the lava";
      break;
    case MOD_TARGET_LASER:
      message = "^5was died by Shock";
      break;
    ...
    case MOD_ASPAWN:
      ...
      break;
    case MOD_MGTURRET:
      if( !cg_lang.integer == en_EN || lang == en_EN )
      message = "^5was gunned down by a turret";
      else if( !cg_lang.integer == pl_PL || lang == pl_PL )
      message = "^5zostal zastrzelony przez wiezy";
      else if( !cg_lang.integer == ru_RU || lang == ru_RU )
      message = "^5Byl zastrelen turrelju";
      break;
    case MOD_MGTURRET2:
      message = "^5was roasted by a flame turret";
      break;
	case MOD_MGTURRET3:
      message = "^5ate a rocket from a turret";
      break;
    case MOD_TESLAGEN:
  ...
  if( attacker != ENTITYNUM_WORLD )
  {
    switch( mod )
    {
      case MOD_PAINSAW:
        ...
        break;
      case MOD_BLASTER:
        message = "^5was gunned by^7";
        message2 = "^5's ^5pistol";
        break;
      case MOD_MACHINEGUN:
	...
	case MOD_SMOKE:
      ...
      case MOD_LEVEL0_NUC:
        message = "^5was died from radiation of^7";
        message2 = "^5's ^5Nuclear Dretch";
        break;
