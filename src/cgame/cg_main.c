...
static cvarTable_t cvarTable[ ] =
{
  ...
  { &cg_hudFilesEnable, "cg_hudFilesEnable", "1", CVAR_ARCHIVE},
  ...
  { NULL, "cg_lang", "en_EN", CVAR_USERINFO | CVAR_ARCHIVE},
...
static void CG_RegisterSounds( void )
{
  ...
  /*
  cgs.media.warpEnterSound          = trap_S_RegisterSound( "sound/player/level6/warp1.wav", qfalse );
  cgs.media.warpExitSound           = trap_S_RegisterSound( "sound/player/level6/warp2.wav", qfalse );
  cgs.media.warpingSound            = trap_S_RegisterSound( "sound/player/level6/warping.wav", qfalse );*/
}
...
static void CG_RegisterGraphics( void )
{
  ...
  /*
  cgs.media.warpEnterPS               = CG_RegisterParticleSystem( "gfx/level6/warpEnterPS" );
  cgs.media.warpExitPS                = CG_RegisterParticleSystem( "gfx/level6/warpExitPS" );
  cgs.media.warpOverlay               = trap_R_RegisterShader( "gfx/level6/warpOverlay" );
  cgs.media.warpOverlayBlocked        = trap_R_RegisterShader( "gfx/level6/warpOverlayBlocked" );
*/
